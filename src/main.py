...
def shortcuts():
    ...
    while welcome_screen:
        ...
        message_to_screen("Play -> p", white, -100, 's')
        message_to_screen("Quit -> q", white, -55, 's')
        message_to_screen("Pause -> b", white, 80, 's')
        message_to_screen("Resume -> r", white, 125, 's')
        message_to_screen("Back -> e", white, -10, 's')
        message_to_screen("Shortcuts -> s", white, 170, 's')
        message_to_screen("Home -> h", white, 35, 's')
        pygame.display.update()
...
def intro():
    ...
    while intro:
        ...
        message_to_screen("Press q for Quit", white, -100, 's')
        message_to_screen("Press p for Play", white, -50, 's')
        message_to_screen("Press s for Shortcuts", white, 0, 's')
        pygame.display.update()
...
def game_loop():
    ...
    snake_list = [[lead_x + 10, lead_y], [lead_x + 20, lead_y], [lead_x + 30, lead_y], [lead_x + 40, lead_y]]
    snake_length = 4
    lead_x_change = 0
    lead_y_change = 0
    ...
    while not gameExit:
        if gameOver:
            ...
            message_to_screen("Press p for Play again!", white, -100, 's')
            message_to_screen("Press q for Quit!", white, -50, 's')
            message_to_screen("Press h for Home!", white, 0, 's')
            pygame.display.update()
        while gameOver:
            pygame.display.update()
            for event in pygame.event.get():
